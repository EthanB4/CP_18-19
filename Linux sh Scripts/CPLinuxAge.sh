...
echo ""
echo ""
printf ""$LRED" Are you sure?$BLANK"
read -p ""
echo ""
sudo echo ""
clear
...
echo ""
sleep .5
printf ""$YELLOW"WARNING: THIS SCRIPT SHOULD ONLY BE RAN ONCE RUNNING IT MORE THAN THAT CAN LEAD TO DUPLICATE TEXT INSIDE THE FILES THAT ARE BEING MODIFIED!"
echo ""
printf ""$WHITE"Press 'Enter' to return to the terminal$BLANK"
read -p ""
